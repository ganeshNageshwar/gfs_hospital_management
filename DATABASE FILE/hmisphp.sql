...
CREATE TABLE `his_docs` (
  ...
  `doc_mobnumber` varchar(200) DEFAULT NULL,
  `doc_email` varchar(200) DEFAULT NULL,
  `doc_pwd` varchar(200) DEFAULT NULL,
  `doc_dept_id` int(10) DEFAULT NULL,
  `doc_edu` varchar(200) DEFAULT NULL,
  `doc_exp` varchar(200) DEFAULT NULL,
  `doc_cunslt_charg` varchar(200) DEFAULT NULL,
...
INSERT INTO `his_docs` (`doc_id`, `doc_name`, `doc_mobnumber`, `doc_email`, `doc_pwd`, `doc_dept_id`, `doc_edu`, `doc_exp`, `doc_cunslt_charg`, `doc_status`, `doc_dpic`) VALUES
(28, 'Raju Sharma', '8569231475', 'raju@gmail.com', '2a9f4fc1ddd8dd4362b68e8755a8808a59f5bbc4', 2, 'MD MBBS', '5 Years', '$500 ', 'Active', 'logo.png');

-- --------------------------------------------------------

--
-- Table structure for table `his_doc_dept`
--

CREATE TABLE `his_doc_dept` (
  `doc_dept_id` int(10) NOT NULL,
  `doc_dept_name` varchar(100) NOT NULL,
  `doc_dept_description` text NOT NULL,
  `status` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `his_doc_dept`
--

INSERT INTO `his_doc_dept` (`doc_dept_id`, `doc_dept_name`, `doc_dept_description`, `status`) VALUES
...
(4, 'Hematology', 'These hospital services work with the laboratory. In addition doctors treat blood diseases and malignancies related to the blood', 'Active'),
...
(8, 'Orthopedics', 'Treats conditions related to the musculoskeletal system, including joints, ligaments, bones, muscles, tendons and nerves', 'Active'),
(9, 'Radiology', 'Deals with the study and application of imaging technology like XRay', 'Active'),
(10, 'Medicine', 'Medicine', 'Active');
...
--
-- Table structure for table `his_opd_patient`
--

CREATE TABLE `his_opd_patient` (
  `opdpatientid` int(10) NOT NULL,
  `opdpatientname` varchar(50) NOT NULL,
  `opdpatientadmissiondate` date NOT NULL,
  `opdpatientadmissiontime` time NOT NULL,
  `opdpatientaddress` varchar(250) NOT NULL,
  `opdpatientmobileno` varchar(15) NOT NULL,
  `opdpatientcity` varchar(25) NOT NULL,
  `opdpatientpincode` varchar(20) NOT NULL,
  `opdpatientemailid` varchar(200) NOT NULL,
  `opdpatientpassword` varchar(25) NOT NULL,
  `opdpatientbloodgroup` varchar(20) NOT NULL,
  `opdpatientgender` varchar(10) NOT NULL,
  `opdpatientdob` date NOT NULL,
  `opdpatientstatus` varchar(10) NOT NULL,
  `opdpatientpic` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `his_opd_patient`
--

INSERT INTO `his_opd_patient` (`opdpatientid`, `opdpatientname`, `opdpatientadmissiondate`, `opdpatientadmissiontime`, `opdpatientaddress`, `opdpatientmobileno`, `opdpatientcity`, `opdpatientpincode`, `opdpatientemailid`, `opdpatientpassword`, `opdpatientbloodgroup`, `opdpatientgender`, `opdpatientdob`, `opdpatientstatus`, `opdpatientpic`) VALUES
(40, 'Ganesh Nageshwar', '2023-11-21', '12:40:59', 'Pune', '9520365874', 'Pune', '431605', 'ganesh@gmail.com', 'Ganesh@1234', 'AB+', 'Male', '2023-11-01', 'Active', '');
...
CREATE TABLE `his_patient` (
  ...
  `pt_fname` varchar(200) NOT NULL,
  `pt_lname` varchar(200) NOT NULL,
  `pt_loginid` varchar(200) NOT NULL,
  `pt_pdw` varchar(200) NOT NULL,
  `pt_ptpic` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(9, 'Lawrence', 'Bischof', '01/19/1990', '32', '5FOWH', '82 Bryan Street', '7412225698', 'InPatient', '2023-11-03 05:32:51.406489', 'Demo Test', NULL),
...
--
-- Indexes for table `his_doc_dept`
--
ALTER TABLE `his_doc_dept`
  ADD PRIMARY KEY (`doc_dept_id`);
...
--
-- Indexes for table `his_opd_patient`
--
ALTER TABLE `his_opd_patient`
  ADD PRIMARY KEY (`opdpatientid`);
...
--
-- AUTO_INCREMENT for table `his_doc_dept`
--
ALTER TABLE `his_doc_dept`
  MODIFY `doc_dept_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `his_opd_patient`
--
ALTER TABLE `his_opd_patient`
  MODIFY `opdpatientid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
