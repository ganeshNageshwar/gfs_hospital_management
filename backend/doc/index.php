                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Doctor Loginid</label>
                                        <input class="form-control" name="doc_email" type="email" id="emailaddress" required="" placeholder="Enter your doctor login id">
                                    </div>
