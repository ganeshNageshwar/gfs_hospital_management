                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_doc_add_opd_patient.php">Add OPD Patient</a>
                                    </li>
                                    <li>
                                        <a href="his_doc_view_opd_patientrecords.php">View OPD Patient Records</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_doc_register_patient.php">Register For Admission</a>
                                    </li>
                                    <li>
                                        <a href="his_doc_view_patients.php">View Admit Patients</a>
                                    </li>
                                    <li>
                                        <a href="his_doc_manage_patient.php">Manage Admit Patients</a>
                                    </li>
                                    <hr>
                                    <li>
