	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $doc_pwd=sha1(md5($_POST['doc_pwd']));
			...
			$query="UPDATE his_docs SET doc_name=?, doc_email=?, doc_dpic=? WHERE doc_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssi', $doc_name, $doc_email, $doc_dpic, $doc_id);
			$stmt->execute();
			/*
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title"><?php echo $row->doc_name;?>'s Profile</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Full Name :</strong> <span class="ml-2"><?php echo $row->doc_name;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Department :</strong> <span class="ml-2"><?php echo $row->doc_dept_id;?></span></p>
                                        <!-- <p class="text-muted mb-2 font-13"><strong>Employee Number :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p> -->
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Email :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Contact :</strong> <span class="ml-2"><?php echo $row->doc_mobnumber;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Education :</strong> <span class="ml-2"><?php echo $row->doc_edu;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Doctor Experience :</strong> <span class="ml-2"><?php echo $row->doc_exp;?></span></p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="doctorname"  class="form-control" id="doctorname" placeholder="<?php echo $row->doc_name;?>">
                                                            </div>
                                                        </div>
                                                         <!-- end col -->
                                                    </div> <!-- end row -->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="email" class="form-control" id="email" placeholder="<?php echo $row->doc_email;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
