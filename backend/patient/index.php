<?php
    ...
    if(isset($_POST['pat_login']))
    {
        ...
        //$doc_pwd = $_POST['doc_pwd'];s
        $stmt=$mysqli->prepare("SELECT opdpatientemailid, opdpatientpassword, opdpatientid FROM his_opd_patient WHERE  opdpatientemailid=? AND opdpatientpassword=? ");//sql to log in user
        ...
        // print_r($rs);
        // exit();
        $_SESSION['opdpatientid']=$pat_id;
        //$_SESSION['doc_loginid'] = $doc_number;//Assign session to doc_number id
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Enter your email address and password to access Patient panel.</p>
                                </div>

                                <form method='post' >

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Patient Loginid</label>
                                        <input class="form-control" name="pat_email" type="email" id="emailaddress" required="" placeholder="Enter your patient login id">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="his_pat_reset_pwd.php" class="text-white-50 ml-1">Forgot your password?</a></p>
