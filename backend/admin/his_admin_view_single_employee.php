                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->doc_name;?></span></p>
                                       <p class="text-muted mb-2 font-13"><strong>Department :</strong> <span class="ml-2"><?php echo $row->doc_dept_id;?></span></p>
