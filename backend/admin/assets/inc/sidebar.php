                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_doc_department.php">Add Doctor Department</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_doc_department.php">View Doctor Department</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <!-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_view_appointment_pending.php">Pending Appointment</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_doctor.php">View Doctor</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_opd_patient.php">Add OPD Patient</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_opd_patientrecords.php">View OPD Patient Records</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_register_patient.php">Register For Admission</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_patients.php">View Admit Patients</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_patient.php">Manage Admit Patients</a>
                                    </li>
                                    <hr>
                                    <li>
