<?php
	...
	if(isset($_POST[submit]))
    {
        ...
        // {
            ...
            {
                echo "<script>alert('doctor department record inserted successfully...');</script>";
            }
            else
            {
...
<div class="form-line">
<input class="form-control" type="text" name="deptname" id="deptname" value="" />
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="text" name="deptdescription" id="deptdescription" value=""/>
</div>
</div>
