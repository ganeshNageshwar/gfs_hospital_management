<?php
    ...
    if(isset($_POST[submit]))
    {
        ...
        {
            $sql ="UPDATE his_doc_dept SET doc_dept_name='$_POST[deptname]', doc_dept_description='$_POST[deptdescription]' WHERE doc_dept_id='$_GET[editid]'";
            if($qsql = mysqli_query($mysqli,$sql))
            {
                echo "<script>alert('doctor department record updated successfully...');</script>";
            }
            else
            {
        ...
        else
        {
            ...
            $sql ="INSERT INTO his_doc_dept (doc_dept_name, doc_dept_description, status) values('$_POST[deptname]','$_POST[deptdescription]','$_POST[select]')";

            if($qsql = mysqli_query($mysqli,$sql))
            {
                echo "<script>alert('doctor department details updated successfully...');</script>";
    ...
    if(isset($_GET[editid]))
    {
        $sql="SELECT * FROM his_doc_dept WHERE doc_dept_id='$_GET[editid]' ";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add Doctor Department</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add Doctor Department Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
<div class="form-group"><label>Doctor Department Name</label> 
<div class="form-line">
<input class="form-control" type="text" name="deptname" id="deptname" value="<?php echo $rsedit[doc_dept_name]; ?>" />
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="text" name="deptdescription" id="deptdescription" value="<?php echo $rsedit[doc_dept_description]; ?>" />
</div>
</div>
