<?php
    ...
    if(isset($_POST[submit]))
    {
        ...
        {
            $sql ="UPDATE his_docs SET doc_name='$_POST[doctorname]', doc_mobnumber='$_POST[mobilenumber]',
            doc_email='$_POST[email]', doc_pwd='$encrypt', doc_dept_id='$_POST[select3]',doc_edu='$_POST[education]', doc_exp='$_POST[experience]',doc_cunslt_charg='$_POST[consultancy_charge]' WHERE doc_id='$_GET[editid]'";
        ...
        else
        {
            ...
            $sql ="INSERT INTO his_docs (doc_name, doc_mobnumber, doc_email, doc_pwd, doc_dept_id, doc_edu, doc_exp, doc_cunslt_charg, doc_status, doc_loginid) values('$_POST[doctorname]','$_POST[mobilenumber]','$_POST[email]','$_POST[password]','$_POST[select3]','$_POST[education]','$_POST[experience]','$_POST[consultancy_charge]','$_POST[select]','$_POST[loginid]')";
    ...
    if(isset($_GET[editid]))
    {
        $sql="SELECT * FROM his_docs WHERE doc_id='$_GET[editid]' ";
    ...
    //     else
    //     {
    //         $sql ="INSERT INTO his_docs (doc_name, doc_mobnumber, doc_email, doc_pwd, doc_dept, doc_edu, doc_exp, doc_cunslt_charg, doc_status, doc_loginid) values('$_POST[doctorname]','$_POST[mobilenumber]','$_POST[email]','$_POST[password]','$_POST[select3]','$_POST[education]','$_POST[experience]','$_POST[consultancy_charge]','$_POST[select]','$_POST[loginid]')";
    //         if($qsql = mysqli_query($mysqli,$sql))
    //         {
...
<div class="form-line">
<input class="form-control" type="text" name="doctorname" id="doctorname" value="<?php echo $rsedit[doc_name]; ?>" />
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="text" name="mobilenumber" id="mobilenumber" value="<?php echo $rsedit[doc_mobnumber]; ?>"/>
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="email" name="email" id="email" value="<?php echo $rsedit[doc_email]; ?>" />
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="password" name="password" id="password" value="<?php echo $rsedit[doc_pwd]; ?>"/>
</div>
</div>

<div class="form-group"><label>Department</label> 
	<div class="form-line">
    <input class="form-control" type="text" name="select3" id="select3" value="<?php echo $rsedit[doc_dept_id]; ?>" readonly/>
</div>
</div>

<div class="form-group"><label>Education</label> 
<div class="form-line">
<input class="form-control" type="text" name="education" id="education" value="<?php echo $rsedit[doc_edu]; ?>" />
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="text" name="experience" id="experience" value="<?php echo $rsedit[doc_exp]; ?>"/>
</div>
</div>
...
<div class="form-line">
<input class="form-control" type="text" name="consultancy_charge" id="consultancy_charge" value="<?php echo $rsedit[doc_cunslt_charg]; ?>"/>
</div>
</div>
