    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <tbody>
       ...
       while($rs = mysqli_fetch_array($qsql))
       {
        ...
        {
          echo "<a href='his_admin_opd_patient.php?editid=$rs[opdpatientid]' class='btn btn-sm btn-success'>Edit</a><a href='his_admin_view_opd_patientrecords.php?delid=$rs[opdpatientid]' class='btn btn-sm btn-danger ml-1'>Delete</a> <hr>
          <a href='his_admin_opd_patientreports.php?opdpatientid=$rs[opdpatientid]' class='btn btn-sm btn-info'>View Report</a>";
        }
        echo "</td></tr>";
      }
      ?> 
